...
@section('content')
    ...
    @foreach ($data as $val)
        <!-- Modal update-->
        <div class="modal fade" id="modalEdit{{ $val->user_id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="/adduser" class="forms-sample" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm"" name="nama"
                                        value="{{ $val->nama }}" placeholder="nama lengkap">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputEmail2" class="col-sm-4 col-form-label">Email</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm"" name="email"
                                        value="{{ $val->email }}" placeholder="nama lengkap">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputEmail2" class="col-sm-4 col-form-label">Telepon</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm"" name="tlp"
                                        value="{{ $val->tlp }}" placeholder="nama lengkap">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm"" name="alamat"
                                        value="{{ $val->alamat }}" placeholder="masukkan alamat">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="jk"
                                            id="optionsRadios1" value="L">
                                        Perempuan
                                        <i class="input-helper"></i>
                                    </label>
                                    <label class="form-check-label ml-1">
                                        <input type="radio" class="form-check-input" name="jk"
                                            id="optionsRadios1" value="P">
                                        Laki-Laki
                                        <i class="input-helper"></i>
                                    </label>
                                </div>
