...
@section('content')
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel mt-2">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('event') }}/1681150527.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('event') }}/1681150540.png" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <h4 class="text-center mt-2 text-primary">Produk T-Shirt</h3>
