                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-6 ps-1">
                                ...
                                <div class="d-flex py-3">
                                    ...
                                    <div class="col-8 d-flex align-items-center text-muted font-weight-light">:
                                        ...
                                        @foreach ($pecahString as $substr)
                                            <input class="form-check-input px-1" type="radio" name="size_order"
                                                value="{{ $substr }}" id="size">
                                ...
                                <div class="d-flex py-3">
                                    ...
                                    <div class="col-8 d-flex align-items-center text-muted font-weight-light">
                                        <input type="number" class="form-control form-control-sm" name="jumlah_pesanan"
                                            id="jumlah_pesanan" placeholder="masukkan jumlah pesanan">
                                    </div>
                                </div>
                                <div class="d-flex py-3">
                                    <div class="col-4 d-flex align-items-center me-4 text-muted font-weight-light">
                                    ...
                                    <div class="col-8 d-flex align-items-center text-muted font-weight-light">
                                        <input type="number" class="form-control form-control-sm" name="total_produk"
                                            id="total_produk" readonly>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="id_expedisi" class="form-control form-control-sm" id="id_expedisi">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="id_pembayaran" class="form-control form-control-sm" id="id_pembayaran">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control form-control-sm" name="tinggalkan_pesan"
                                    id="tinggalkan_pesan" id="exampleInput" placeholder="tinggalkan pesan">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-sm btn-gradient-warning me-2"
                                data-bs-dismiss="modal">Cancel</button>
                            <button type="button" id="submit-data-pesanan" class="btn btn-sm btn-gradient-success me-2"
